...
/// Hosts the single bottom nav bar shared by every tab (홈/학습/보상/마이).
/// The floating "AI 코치" button opens a quick-action sheet wired to real
/// plan-modification/regeneration calls rather than a chat UI.
