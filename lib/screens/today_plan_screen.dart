...
class _Header extends StatelessWidget {
  const _Header({required this.date, required this.studentName, required this.streakDays});
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text('$studentName의 오늘 학습 여정', style: const TextStyle(fontSize: 12.5, color: AppColors.gray)),
            ],
          ),
        ),
        Container(
              ...
              InkWell(
                ...
                child: Padding(
                  ...
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(_items[i].$1, size: 22, color: i == currentIndex ? AppColors.primary : AppColors.gray),
                      const SizedBox(height: 2),
                      Text(
                        _items[i].$2,
                        style: TextStyle(
                          fontSize: 11,
                          color: i == currentIndex ? AppColors.primary : AppColors.gray,
